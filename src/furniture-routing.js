...
import { FURNITURE_ASSETS, assetFor } from './furniture-assets.js?v=442';
import { furnitureContract, hasFurnitureContract } from './furniture-contracts.js?v=442';
import { roomDesign, isPlanned } from './room-design.js?v=442';
