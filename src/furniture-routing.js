...
import { FURNITURE_ASSETS, assetFor } from './furniture-assets.js?v=414';
import { furnitureContract, hasFurnitureContract } from './furniture-contracts.js?v=414';
import { roomDesign, isPlanned } from './room-design.js?v=414';
