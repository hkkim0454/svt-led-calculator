...
import { FURNITURE_ASSETS, assetFor } from './furniture-assets.js?v=430';
import { furnitureContract, hasFurnitureContract } from './furniture-contracts.js?v=430';
import { roomDesign, isPlanned } from './room-design.js?v=430';
