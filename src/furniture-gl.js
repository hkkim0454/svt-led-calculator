...
import { u } from './gl-model.js?v=445';
import { createMaterialLibrary } from './materials-gl.js?v=445';
import { PART_MATERIAL, PART_FINISH, PART_FINISH_ALIASES, finishForPart } from './materials.js?v=445';
import { GRADE_COLORS } from './viewangle.js?v=445';
import { createGeometryCache } from './geometry-gl.js?v=445';
import { resolveFurnitureForDesign } from './furniture-routing.js?v=445';
import {
...
import {
  ...
  createLargeUTable,
} from './furniture-assets.js?v=445';
