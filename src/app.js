...
import { CUBE_VIEWS, DEFAULT_CUBE_VIEW, cubeView } from './scene3d.js?v=422';
import { ROOM_TYPES, DEFAULT_ROOM_TYPE, roomType, defaultOptions, normalizeOptions, autoDepthForType, layoutRoom, personSpot } from './room-presets.js?v=422';
import { createViewerGL } from './render3d-gl.js?v=422';
import { buildGLModel, CAMERA_PRESETS, DEFAULT_PRESET, cameraPreset } from './gl-model.js?v=422';
import { annotateSeatViews, GRADE_LABELS } from './viewangle.js?v=422';
import { normalizeDesign } from './room-design.js?v=422';
import { FOV_RANGE, clampFov } from './gl-model.js?v=422';
import { sideMonitorLayout } from './monitors.js?v=422';
import { ledImageFit } from './led-image.js?v=422';
import { RENDER_MODES, DEFAULT_RENDER_MODE } from './render-mode.js?v=422';
...
function renderPreview3D() {
  ...
  viewer3d.setModel(buildGLModel({
    ...
    design: designId,       // 위에서 정한 값을 그대로 — 배치와 렌더가 갈라지지 않게 한다
